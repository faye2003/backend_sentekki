"""
Django settings for api_sentekki project.
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(minutes=30),  # par défaut 5 min
...
SECRET_KEY = 'django-insecure-puk+21epjqgec*3gu9gw-=fb)k#rulqwppzw=(hgdpi45u(1vx'
...
ROOT_URLCONF = 'api_sentekki.urls'
...
WSGI_APPLICATION = 'api_sentekki.wsgi.application'
